...
class kurento_connection:
    ...
    def __init__(self,on_open,kms_url):
        ...
        self.ws = websocket.WebSocketApp(self.kms_url,on_message= lambda ws,msg: self.on_message(ws,msg),on_open = lambda ws,msg :on_open(self,ws,msg))
    ...
    def get_media_element(self,response_id):
        ...
        for media_element in self.media_elements:
            if(media_element.object_id in response_id):
    ...
    def on_message(self,ws,message):
        ...
        media_element = self.get_media_element(response_id)
