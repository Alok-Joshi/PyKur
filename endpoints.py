...
class webrtc_endpoint(media_element):
    ...
    def process_sdp_offer(self,sdp_offer,callback,*callback_args):
    ...
    def gather_ice_candidates(self,callback,*callback_args):
...
class player_endpoint(media_element):
    ...
    def pause(self,callback,*callback_args):
    ...
    def stop(self,callback,*callback_args):
