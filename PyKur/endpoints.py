...
class webrtc_endpoint(media_element):
    ...
    async def add_ice_candidate(self, candidate, callback=None, *callback_args):
    ...
    async def gather_ice_candidates(self, callback=None, *callback_args):
...
class player_endpoint(media_element):
    ...
    async def play(self, callback=None, *callback_args):
    ...
    async def pause(self, callback=None, *callback_args):
    ...
    async def stop(self, callback=None, *callback_args):
